...
//set the pin
/////////////////////////////////////////////////////////////////////
const int chipSelectPin = 10;//SDA //mega2560 use 53 port , uno use 10 port.
const int NRSTPD = 9; //RST
int i = 0;
const int servoPin = 2;//Servo
const int relayPin =3;//relay
...
Servo myservo;
//uchar IDs[4][4] = {0xB2332D75, 0x302726CB, 0xF795A9BD, 0xA2C19155};
void setup() {
  Serial.begin(9600);
...
void sweep(){
//  for (pos = 50; pos <= 140; pos += 20) { // goes from 0 degrees to 180 degrees
//    // in steps of 1 degree
//    myservo.write(pos);              // tell servo to go to position in variable 'pos'
//    delay(05);                       // waits 15ms for the servo to reach the position
//  }
//  
//  for (pos = 140; pos >= 50; pos -= 20) { // goes from 180 degrees to 0 degrees
//    myservo.write(pos);              // tell servo to go to position in variable 'pos'
//    delay(05);                       // waits 15ms for the servo to reach the position
//  }
//  delay(500);
...
bool readingRFID() {
  ...
  if (status == MI_OK)
  {
    ...
    //    }
    if ( id[0] == ljw1 && id[1] == ljw2 && id[2] == ljw3 && id[3] == ljw4)
      {Serial.println("Hello LJW!");
     openDoor();
      }else
    if ( id[0] == jw1 && id[1] == jw2 && id[2] == jw3 && id[3] == jw4)
     { Serial.println("Hello JW");
      openDoor();
     }
      else
     if ( id[0] == zjh1 && id[1] == zjh2 && id[2] == zjh3 && id[3] == zjh4)
      {Serial.println("Hello ZJH");
      openDoor();
      }
      else
      if ( id[0] == qh1 && id[1] == qh2 && id[2] == qh3 && id[3] == qh4)
     { Serial.println("Hello QH");
     openDoor();
